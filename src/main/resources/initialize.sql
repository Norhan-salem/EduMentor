...
SELECT 1 FROM pg_database WHERE datname = 'EDUMentor';
...
(
    "OnlineDonorID" integer NOT NULL DEFAULT nextval('"OnlineDonor_OnlineDonorID_seq"'::regclass),
    "NumberofDonations" smallint NOT NULL,
    CONSTRAINT "OnlineDonor_pkey" PRIMARY KEY ("OnlineDonorID"),
    CONSTRAINT "OnlineDonorForeignKey" FOREIGN KEY ("OnlineDonorID")
...
(
    ...
    CONSTRAINT "Admin_fkey" FOREIGN KEY ("AdminID")
        REFERENCES public."User" ("UserID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    "MentorID" integer NOT NULL DEFAULT nextval('"Mentor_MentorID_seq"'::regclass),
    CONSTRAINT "Mentor_pkey" PRIMARY KEY ("MentorID"),
    CONSTRAINT "Mentor_fkey" FOREIGN KEY ("MentorID")
        REFERENCES public."User" ("UserID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    "FeedbackID" bigint NOT NULL DEFAULT nextval('"Feedback_FeedbackID_seq"'::regclass),
...
(
    "TopicsID" integer NOT NULL DEFAULT nextval('"Topics_TopicsID_seq"'::regclass),
    "TopicsName" text COLLATE pg_catalog."default" NOT NULL,
    "IsDeleted" boolean NOT NULL,
    CONSTRAINT "Topics_pkey" PRIMARY KEY ("TopicsID")
)
...
(
    ...
    CONSTRAINT "MT_InterestedIn_MID_fkey" FOREIGN KEY ("MentorID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "MT_InterestedIn_TID_fkey" FOREIGN KEY ("TopicsID")
        REFERENCES public."Topics" ("TopicsID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "MTT_InterestedIn_MID_fkey" FOREIGN KEY ("MenteeID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "MTT_InterestedIn_TID_fkey" FOREIGN KEY ("TopicsID")
        REFERENCES public."Topics" ("TopicsID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "ODD_Makes_DID_fkey" FOREIGN KEY ("DonationID")
        REFERENCES public."OnlineDonation" ("DonationID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "ODD_Makes_ODID_fkey" FOREIGN KEY ("OnlineDonorID")
        REFERENCES public."OnlineDonor" ("OnlineDonorID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "AS_Makes_AID_fkey" FOREIGN KEY ("AdminID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "AS_Makes_SID_fkey" FOREIGN KEY ("SessionID")
...
(
    ...
    CONSTRAINT "SMTT_Takes_MID_fkey" FOREIGN KEY ("MenteeID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "SMTT_Takes_SID_fkey" FOREIGN KEY ("SessionID")
        REFERENCES public."Session" ("SessionID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "FS_Has_FID_fkey" FOREIGN KEY ("FeedbackID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "FS_Has_SID_fkey" FOREIGN KEY ("SessionID")
        REFERENCES public."Session" ("SessionID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "FM_Gives_FID_fkey" FOREIGN KEY ("FeedbackID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "FM_Gives_MID_fkey" FOREIGN KEY ("MenteeID")
        REFERENCES public."Mentee" ("MenteeID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT "SM_Gives_MID_fkey" FOREIGN KEY ("MentorID")
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "SM_Gives_SID_fkey" FOREIGN KEY ("SessionID")
        REFERENCES public."Session" ("SessionID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
